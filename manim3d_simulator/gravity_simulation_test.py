...
class GravitySimulation(ThreeDScene):
    def construct(self):
        ...
        light.move_to([3, 0, 2])  # Start at a 3D position # Position the light at the left side of the screen
        ...
        # Animation
        self.play(light.animate.move_to(gravity_source.get_center()), run_time=2)
