...
while running:
    ...
    bend_position_x = GRAVITY_SOURCE_X + math.cos(math.radians(angle -180)) * DISTANCE_BETWEEN_LIGHT_RAY_AND_GRAVITY_SOURCE 
    bend_position_y = GRAVITY_SOURCE_Y + math.sin(math.radians(angle + 90)) * DISTANCE_BETWEEN_LIGHT_RAY_AND_GRAVITY_SOURCE
    ...
    print("Distance: ", light_bend_position.distance_to(gravity_source))
