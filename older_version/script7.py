...
######################################################################################################################################################
 # Draw the light ray that is perpendicular to the line connecting the light source and the gravity source
    ...
    # light_ray_end_position.from_polar((DISTANCE_BETWEEN_LIGHT_RAY_AND_GRAVITY_SOURCE, perpendicular_angle))
    reflected_light_ray_end_position.from_polar((DISTANCE_BETWEEN_LIGHT_RAY_AND_GRAVITY_SOURCE, reflected_angle))
    print("Perpendicular angle: ", perpendicular_angle)
    print("Reflected angle: ", reflected_angle)
    # pygame.draw.line(window, (255, 255, 255), light_source, light_ray_end_position, 2)
    pygame.draw.line(window, (255, 255, 255), light_source, reflected_light_ray_end_position, 2)
